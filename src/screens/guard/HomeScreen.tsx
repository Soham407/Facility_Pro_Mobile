...
export function HomeScreen() {
  ...
  const handleCheckInPress = async () => {
    ...
    try {
      ...
      if (!isInside) {
        Alert.alert(
          "Outside Geofence",
          `You are outside the designated area. Please move to your post and try again.`,
        );
        setIsProcessing(false);
        return;
      }
      ...
      if (!camPerm.granted) {
        Alert.alert(
          "Permission Denied",
          "Please enable camera in Settings -> Apps -> FacilityPro.",
        );
        setIsProcessing(false);
        return;
      }
  ...
  const handleCheckOut = async () => {
    ...
    try {
      ...
      if (!guardData?.todayAttendance?.id)
            ...
            <View style={styles.cameraActions}>
              ...
              >
                {isProcessing ? (
                  ...
                  <Text style={styles.camBtnText}>Use Photo</Text>
                )}
              </TouchableOpacity>
            </View>
          </View>
  ...
  const isComplete =
    guardData.todayAttendance &&
    guardData.todayAttendance.check_out_time !== null;
    ...
    <ScreenWrapper>
      <View style={styles.header}>
        <Text style={styles.guardName}>
          ...
          {guardData.securityGuard.guard_code})
        </Text>
        <Text style={styles.location}>
          {guardData.assignedLocation?.location_name || "Unassigned Location"}
        </Text>
        ...
        {isComplete ? (
          ...
          <View style={styles.checkedInView}>
            ...
            <Text style={styles.timeValue}>
              {new Date(
                guardData.todayAttendance!.check_in_time!,
            ...
            >
              {isProcessing ? (
                ...
                <Text style={styles.bigActionText}>CHECK OUT</Text>
              )}
            </TouchableOpacity>
          ...
          <View style={styles.checkInView}>
            ...
            >
              {isProcessing ? (
                ...
                <Text style={styles.bigActionText}>CHECK IN</Text>
              )}
            </TouchableOpacity>
